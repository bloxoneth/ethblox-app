      ...
      {placedNFTs.length > 0 && (
        <div className="absolute top-[calc(3.5rem+0.5rem)] left-[180px] md:left-[220px] z-40">
          <div className="relative">
            ...
            {/* Dropdown */}
            {isNFTCounterExpanded && (
              <div className="absolute top-full left-0 mt-1 bg-[hsl(210,11%,18%)] backdrop-blur-lg rounded-lg border border-[hsl(210,8%,28%)] shadow-2xl overflow-hidden min-w-[160px]">
