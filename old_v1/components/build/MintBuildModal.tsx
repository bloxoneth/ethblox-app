...
import { ChevronDown, ChevronUp, X, Loader2, ExternalLink, CheckCircle2, AlertCircle } from "lucide-react"
...
export function MintBuildModal({
  ...
  baseWidth,
  baseDepth,
  composition = {}, // Added default value for composition
  metadata,
}: MintBuildModalProps) {
  ...
  const estimatedLicenseFeeEth = 0.01 // Fixed placeholder
